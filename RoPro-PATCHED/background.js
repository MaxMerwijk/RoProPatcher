...
async function fetchServerInfo(placeID, servers) {
  return new Promise((resolve) => {
    ...
    fetch("https://ropro-proxy.deno.dev/getServerInfo.php///api?form", {
      method: "POST",
      body: formData,
    })
      .then((response) => response.json())
...
async function fetchServerConnectionScore(placeID, servers) {
  return new Promise((resolve) => {
    ...
    fetch("https://ropro-proxy.deno.dev/getServerConnectionScore.php///api?form", {
      method: "POST",
      body: formData,
    })
      .then((response) => response.json())
...
async function fetchServerAge(placeID, servers) {
  return new Promise((resolve) => {
    ...
    fetch("https://ropro-proxy.deno.dev/getServerAge.php///api", {
      method: "POST",
      body: formData,
    })
      .then((response) => response.json())
  ...
  return new Promise(async (resolve) => {
    fetch("https://users.roblox.com/v1/users/authenticated").then(
      async (response) => {
        ...
        fetch("https://ropro-proxy.deno.dev/validateUser.php///api", {
          method: "POST",
          headers: {
            "ropro-verification": roproVerificationToken,
            "ropro-id": userID,
...
async function fetchSubscription() {
  return new Promise(async (resolve) => {
    ...
    fetch("https://ropro-proxy.deno.dev/getSubscription.php///api", {
      method: "POST",
      headers: {
        "ropro-verification": roproVerificationToken,
        "ropro-id": userID,
