...
async function fetchServerInfo(placeID, servers) {
	return new Promise(resolve => {
		chrome.runtime.sendMessage({greeting: "PostURL", wrap_json: true, url:"https://ropro-proxy.deno.dev/getServerInfo.php///api?form", jsonData: {'placeID':placeID, 'servers': servers}}, 
			function(data) {
				resolve(data)
			}
		)
